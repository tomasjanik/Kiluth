...
//renderProjects($row[ID], $row[name], $row[subtitle], $row[business], $row[location], $row[region], $row[folder], $row[description], $row[identity], $row[prints], $row[digital]);
    ?>
...
?>
                            ...
                            <?php }; ?>
                                <div class="small-space"></div> <a class="long-button text-black text-smaller" href="logbook.php">View Logbook</a> </div>
                </div>
            </div>
